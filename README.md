...
# Getting started
I keep all my custom scritps in `C:/Users/MyUser/Bin` which is in the `$PATH` environment variable, if it isnt add whichever folder you decide to use. These scripts expects to be used this way and will not work without being detected within `$PATH`
